...
public class JamesHelper {
  ...
  public void drainEmail(String username, String password) throws MessagingException, javax.mail.MessagingException {
  ...
  private void closeFolder(Folder folder) throws MessagingException, javax.mail.MessagingException {
    folder.close(true);
    store.close();
  }
